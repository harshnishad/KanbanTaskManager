  ...
  return (
    <div className='fixed left-0 top-0 md:w-[230px] w-[60px] overflow-hidden h-full flex flex-col'>
      ...
      <div className="w-full h-[calc(100vh-70px)] border-r flex flex-col md:items-start items-center gap-2 border-slate-300 bg-white py-5 px-3 relative">
        ...
        {/* Log Out Button */}
        <div className='flex absolute bottom-4 items-center md:justify-center gap-2 md:w-[90%] w-[70%] rounded-lg hover:bg-orange-300 px-2 py-3 cursor-pointer bg-grey-200'>
